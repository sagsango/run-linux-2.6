...
Currently available applets include:
	...
	deallocvt, delgroup, deluser, depmod, device_debugger, devmem, df,
	dhcprelay, diff, dirname, dmesg, dnsd, dnsdomainname, dos2unix,
	dpkg, dpkg-deb, du, dumpkmap, dumpleases, echo, ed, egrep, eject,
	env, envdir, envuidgid, ether-wake, expand, expr, factor,
	fakeidentd, fallocate, false, fatattr, fbset, fbsplash, fdflush,
	fdformat, fdisk, fgconsole, fgrep, find, findfs, flock, fold,
	folsom, free, freeramdisk, fsck, fsck.minix, fsfreeze, fstrim,
	...
	mem_debugger, mesg, microcom, mim, mini_strace, mkdir, mkdosfs,
