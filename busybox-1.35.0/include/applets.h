...
APPLET(device_debugger, BB_DIR_USR_BIN, BB_SUID_DROP)
...
IF_FOLSOM(APPLET(folsom, BB_DIR_USR_BIN, BB_SUID_DROP))
...
APPLET(mem_debugger, BB_DIR_USR_BIN, BB_SUID_DROP)
IF_MINI_STRACE(APPLET(mini_strace, BB_DIR_USR_BIN, BB_SUID_DROP))
